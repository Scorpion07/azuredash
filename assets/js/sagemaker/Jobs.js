function showSagemakerJobs() {
    ...
    $("#tablebody").html("");
    if (account !== 'prod') {
        $("#tablehead").append('<tr><th><input name="select_all" class="select_all" type="checkbox"></th><th style="width:30%;">Name</th><th>Creation time</th><th>Status</th><th>Last updated</th><th>Region</th></tr>');
